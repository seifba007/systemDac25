...
const CalendarPage = () => {
  ...
  const handleAddOrUpdateEvent = (formData: any) => {
    const newEvent: EventsListType = {
      ...
      end: new Date(new Date(formData.endDate).setDate(new Date(formData.endDate).getDate() + 1) - 1), // Adjust end date
  ...
  return (
    <Stack px="lg">
        ...
        <Flex gap={'2em'} wrap={'wrap'}>
          <Box w={'14em'}>
            <Button
              ...
              onClick={()=>{setIsEditing(false);open()}}
            >
      ...
      <Modal opened={opened2} onClose={close2} radius={12} size={504} centered overlayProps={{
            ...
            <Stack>
              <Group gap={8}>
                ...
                <Group gap={8}>
                  ...
                  <Text span>--&gt;</Text>
                  <Text fz={rem(14)} c={'#53545E'}>seifbenaicha</Text>
                </Group>
              </Group>
              <Group gap={8}>
                <TickCircle size={'20'} color="lime" variant='Bold' />
              ...
              <Group gap={8}>
                ...
                <Group gap={8}>
                  ...
                  <Text span>--&gt;</Text>
                  <Text fz={rem(14)} c={'#53545E'}>{selectedEvent?.typeOfWorkOrder}</Text>
                </Group>
              </Group>
              ...
              <Group gap={8}>
                ...
                <Group gap={8}>
                  <Text fz={rem(14)} c={'#53545E'}>
                    <Text fz={12}>Priority Level
                    </Text>
                  </Text>
                  <Text span>--&gt;</Text>
                  <Text fz={rem(14)} c={'#53545E'}>{selectedEvent?.PriorityLevel}</Text>
                </Group>
              </Group>
              <Group gap={8}>
              ...
              <Stack>
                <Flex align={'center'} gap={10}>
                  ...
                  <Badge variant="outline" color='green'>
                    <Text fz={10} fw={600}>Complete</Text>
                  </Badge>
                </Flex>
              </Stack>
