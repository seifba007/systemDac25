							...
							<Table.Tr key={index}>
								...
								<Table.Td>
									<TextInput
										...
										onChange={(e) => handleInputChange(index, 'title', e.currentTarget.value)}
									/>
								</Table.Td>
								<Table.Td>
									<Select
								...
								<Table.Td>
									<TextInput
										...
										onChange={(e) => handleInputChange(index, 'asset', e.currentTarget.value)}
									/>
								</Table.Td>
								<Table.Td>
									<TextInput
								...
								<Table.Td>
									<Button color='red' size='xs' onClick={() => handleDelete(index)}>
										<Trash size={15} />
									</Button>
								</Table.Td>
							</Table.Tr>
