...
import { Modal, TextInput, Button, Flex, Box, Title, FileInput, Text, Textarea, Avatar, Table, Checkbox, rem, Select, SelectProps, Group, ScrollArea, Input } from '@mantine/core';
...
>
  ...
  <ScrollArea h={460} >
      ...
      <Table.Thead>
        <Table.Tr>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>App</Text></Table.Th>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>Icon</Text></Table.Th>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>Access Type	</Text></Table.Th>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>Start Date	</Text></Table.Th>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>End Date	</Text></Table.Th>
          <Table.Th><Text fz={'15px'} c={"#6c757d"}  fw={"600"}>Nbr of Licenses</Text>
          </Table.Th>
        </Table.Tr>
      </Table.Thead>
