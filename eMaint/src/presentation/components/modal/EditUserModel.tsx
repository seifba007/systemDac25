...
import { Modal, TextInput, Button, Flex, Box, Title, FileInput, Text, PasswordInput } from '@mantine/core';
    ...
    >
      <Flex direction="column" gap="md">
        <TextInput
          ...
          label={<Text   pb={'0.5em'} c={'#868e96'}>Username</Text>}
          onChange={(e) => handleInputChange('Username', e.target.value)}
        />
        <TextInput
          label={<Text  pb={'0.5em'} c={'#868e96'}>Email</Text>}
          value={formData.Email}
          onChange={(e) => handleInputChange('Email', e.target.value)}
        />
        <TextInput
          value={formData.Organization}
          label={<Text  pb={'0.5em'}  c={'#868e96'}>Organization</Text>}
          onChange={(e) => handleInputChange('Organization', e.target.value)}
        />
        <TextInput
          label={<Text  pb={'0.5em'} c={'#868e96'}>Role</Text>}
          value={formData.Role}
        ...
        leftSection={<Folder
          ...
          variant="Bold"
         />}
        label={<Text   pb={'0.5em'} c={'#868e96'}>Picture</Text>}
