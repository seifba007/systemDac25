...
import { Avatar, Box, Center, Flex, Indicator, Menu, ScrollArea, Text } from '@mantine/core';
...
const NotificationNav: React.FC<NotificationNavProps> = ({ data }) => {
	...
	return (
		<Menu shadow='md' width={200} position='bottom-end' offset={2}>
			<Menu.Target>
				{isMobile ? (
					<Indicator inline processing color='red' size={9}>
					...
					<Indicator inline processing color='red' size={9} mt={'0.5em'}>
						{' '}
