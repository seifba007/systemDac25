...
export const formFieldsReport: FormField[] = [
	{
		...
		options: [{ label: 'Service Quality', value: 'serviceQuality' }],
		required: true,
	},
	{
		label: 'Report Type',
		...
		type: 'select',
		name: 'reportType',
		options: [{ label: 'Hazardous Situation', value: 'hazardousSituation' }],
		required: true,
	},
	{
		label: 'Date and Time',
	...
	},
	{
		...
		options: [{ label: 'SmarDac', value: 'smarDac' }],
		required: true,
	},
	{
...
export const formFieldsRisk: FormField[] = [
	...
	},
	{
		...
		type: 'select',
		name: 'client',
		options: [{ label: 'No client involved', value: 'noClient' }],
	},
	{
		label: 'Date',
		value: '',
