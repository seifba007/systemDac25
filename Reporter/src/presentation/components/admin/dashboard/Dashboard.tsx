...
export const data: ProductSales[] = [{ product: 'Apples', sales: 120 }];
...
export const data4: DailyApples[] = [{ date: 'Mar 22', Apples: 50 }];

export const data5: CountryData[] = [{ name: 'USA', value: 400, color: 'indigo.6' }];
