...
const ApproveItem: React.FC<ModelFilterProps> = ({
	...
	const handleUpdate = (userId: string, certId: string, isValid: boolean, validationDate: any) => {
		updateUserCertificate(userId, certId, isValid, validationDate);
	};
										...
										<Input
											...
											value={
												assignment.certificate.validationDate
													? new Date(assignment.certificate.validationDate)
															.toISOString()
															.split('T')[0]
													: ''
											}
