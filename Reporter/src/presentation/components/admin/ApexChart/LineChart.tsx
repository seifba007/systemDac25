...
const LineChart: React.FC = () => {
  ...
  return (
    <div>
      <div id="chart">
        <ReactApexChart options={state.options as ApexOptions} series={state.series} type="line" height={350} />
          <Stack>
        <Stack gap={'0.5em'}>
              <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Total Incident Reports
              </Text>
            ...
            <Stack  gap={'0.5em'}>
              <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Resolved Incidents
              </Text>
            <Progress.Root size="lg" >
            ...
            <Stack  gap={'0.5em'}>
              <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Pending Incidents
              </Text>
            <Progress.Root size="lg" >
