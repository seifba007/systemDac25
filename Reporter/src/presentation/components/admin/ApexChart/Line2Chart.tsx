  ...
  return (
    <div>
      <div id="chart">
        ...
        <Stack gap={'1em'}>
    <Stack gap={'0.5em'}>
          <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Total Environment Reports
        ...
        <Stack  gap={'0.5em'}>
          <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Completed Reports
        ...
        <Stack  gap={'0.5em'}>
          <Text c={'rgb(17 18 18 / 83%)'} fz={'14px'}>Pending Reports
