...
import { Stack, Text, Table, Button, FileInput, ActionIcon, Flex, TextInput, Textarea, Select } from '@mantine/core';
...
interface HazopAnalysisProps {
  close?: () => void; // Optional prop to close a modal or form
}

const HazopAnalysis = ({ close }: HazopAnalysisProps) => {
          ...
          <Stack>
            ...
            <Stack >
              <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                System/Process Name <Text component="span" c="red">*</Text>
              </Text>
              <TextInput
            ...
            <Stack >
              <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                Objectives <Text component="span" c="red">*</Text>
              </Text>
              <Textarea
            ...
            <Stack >
              <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                Boundaries <Text component="span" c="red">*</Text>
              </Text>
              <Textarea
            ...
            <Flex gap={'1em'}  wrap="wrap">
              <Stack  w="30%">
                <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                  Start Date <Text component="span" c="red">*</Text>
                </Text>
                <TextInput
              ...
              <Stack  w="30%">
                <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                  End Date <Text component="span" c="red">*</Text>
                </Text>
                <TextInput
                  placeholder="Enter yyyy"
                  type="date"
              ...
              <Stack  w="37%">
                <Text ff={'"Roboto",sans-serif'} fw={'600'} c={'#6c757d'} fz={'13px'}>
                  Review Frequency <Text component="span" c="red">*</Text>
                </Text>
                <Select
                  placeholder="Monthly"
