...
const AddlIncidentReporting = () => {
	...
	const likelihoodSeverityData = useMemo(
		() => ['Very Low (1)', 'Low (2)', 'Moderate (3)', 'High (4)', 'Very High (5)'],
		[],
	);
	const severityOfTheEventData = useMemo(
	...
	const handleSubmit = useCallback(
		async (e: React.FormEvent) => {
			...
			const data = {
				...
				reportTitle,
				reportDescription,
				likelihood: likelihood.split(' (')[0] || '', // Extract number (e.g., "1" from "Very Low (1)")
	...
	const handleRiskCellClick = useCallback(
		(selectedLikelihood: string, selectedSeverity: string) => {
