...
const AddMProcedure = () => {
  const [sections, setSections] = useState<{ id: number; items: { id: number; description: string; comment: string }[] }[]>([]);
      ...
      prevSections.map((section) =>
        section.id === sectionId
          ? {
            ...
            items: [
              ...section.items,
              { id: Date.now(), description: '', comment: '' },
            ],
          }
          : section
      )
  ...
  return (
    <Stack>
            ...
            {sections.map((section) => (
              ...
              >
                ...
                >
                  ...
                  <ActionIcon variant="filled" color="red" w={'25px'} h={'20px'} onClick={() => handleDeleteSection(section.id)}
                  >
      ...
      <span className="file-name">{"fileName"}</span>
                          ...
                          <Table.Td>
                            <ActionIcon variant="filled" color="red" w={'25px'} h={'20px'} onClick={() => handleDeleteItem(section.id, item.id)}
                            >
                              <Trash color='#fff' size={'15'} variant='Bold' />
                            </ActionIcon>
