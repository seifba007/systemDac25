     ...
     <Text
      ...
      >  Upload Spare Parts File    </Text>
       <Text
        ...
        fz={'12px'}
      >Download the sample template, fill it with your spare parts data, and upload it here. You can manually assign equipment associations after uploading.
</Text>
...
<Button variant="outline" w={'12em'} >
      ...
      >   Download </Text>
        ...
        c={'#6c757d'}
        fz={'14px'}
      >  Upload Spare Parts Excel File (.xls, .xlsx)  </Text>
         <FileInput
         accept='.xls,.xlsx'
                        label=""
