...
import TabsButton from './TabsButtonStore'
...
const [isLoading, setIsLoading] = useState<boolean>(true);
  return (
    ...
    <Stack>
      ...
      <Text style={{textOverflow:'ellipsis',overflow:'hidden',whiteSpace: "nowrap"}} ff={'"Roboto",sans-serif'} fw={'500'} c={'#6c757d'} fz={'15px'}>
      Use the tabs below to navigate through different store inventories.
