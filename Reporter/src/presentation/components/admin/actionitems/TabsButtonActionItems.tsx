...
const TabsButton: React.FC<TabsButtonProps> = ({
	...
	const [dataOrganization] = useState<any>([]);
									...
									<Table.Tbody>
										{data?.map((item, index) => (
											<Table.Tr key={index}>
												...
												<Table.Td>
													<Text className='txttablename' fz={'10px'}>
												...
												<Table.Td>
													<Flex gap='0.2em'>
														...
														<Text className='txttablename'>
															{formatDate(item?.targetDate?.$date)}
														</Text>
													</Flex>
												</Table.Td>
												<Table.Td>
													<Flex gap='0.5em'>
														<ActionIcon
															...
															h='20px'
															onClick={() => {
																setModalOpenApproveiteam(true), setReject(false);
