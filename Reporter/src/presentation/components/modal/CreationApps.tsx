...
import { 
  Modal, TextInput, Button, Flex, Box, Title, FileInput, Text, Textarea, Avatar, Switch, MultiSelect 
} from '@mantine/core';
    ...
    >
      <Flex direction="column" gap="0.6em">
        ...
        <FileInput
          ...
          label={<Text pb="0.3em" color="#868e96">Upload Logo</Text>}
        ...
        <TextInput
          value={Apps.Name}
          label={<Text pb="0.3em" color="#868e96">Name</Text>}
        ...
        <Textarea
          ...
          label={<Text pb="0.3em" color="#868e96">Description</Text>}
        ...
        <TextInput
          value={Apps.Path}
          label={<Text pb="0.3em" color="#868e96">Path</Text>}
          onChange={(e) => handleInputChange('Path', e.target.value)}
        />

        {/* Active Switch */}
        <Box>
          <Text pb="0.3em" color="#868e96">Active</Text>
          <Switch
            checked={Apps.Active}
        ...
        <MultiSelect
          ...
          label={<Text pb="0.3em" color="#868e96">Categories</Text>}
        ...
        <MultiSelect
          ...
          label={<Text pb="0.3em" color="#868e96">Tags</Text>}
