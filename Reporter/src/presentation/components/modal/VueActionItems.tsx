...
const VueActionItems: React.FC<ModelFilterProps> = ({
	...
	const efficiencyFollowUp =
		formData?.followUps?.find((f: any) => f.followUpType === 'efficiency') || {};
	...
	const handleInputChange = (field: string, value: any, followUpType: string) => {
		...
		setFormData((prevData: any) => {
			...
			const existingFollowUpIndex = followUps.findIndex(
				(f: any) => f.followUpType === followUpType,
			);
		...
		>
			<Stack>
					...
					<Tabs.Panel value='1' pt='2em'>
						<Stack>
							<DateInput
								...
								label={
									<Text fw='600' fz='14px' c='rgb(34 34 34 / 58%)'>
										Target Date
									</Text>
								}
					...
					<Tabs.Panel value='2' pt='2em'>
						<Stack>
							...
							<Textarea
								...
								onChange={(e) =>
									handleInputChange('followUpDescription', e.target.value, 'control')
								}
					...
					<Tabs.Panel value='3' pt='2em'>
						<Stack>
							...
							<Textarea
								...
								onChange={(e) =>
									handleInputChange('followUpDescription', e.target.value, 'efficiency')
								}
				...
				<Flex justify='space-between' w='100%'>
					...
					{isUpdate && <Button onClick={handleSubmit}>Submit</Button>}
				</Flex>
			</Stack>
		</Modal>
	);
