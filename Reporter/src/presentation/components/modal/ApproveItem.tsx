...
const ApproveItem: React.FC<ModelFilterProps> = ({
  ...
  return (
    ...
    size="35em"
      ...
      styles={{
        header: { gap: '6em', alignItems: 'flex-start',background:isReject?'#f7473a':'#159488'},
      }}
      radius="5px"
    >
   <Stack mt={'1em'}>
   <Text fw={'700'} fz={'13px'} c={'#868e96'}>
  {isReject?'Confirm your rejection for this item.':'Confirm your approval for the initial stage. Please select the final approver:'}
{
  isReject?null: <Autocomplete  rightSectionPointerEvents="none"
