...
const Login = () => {
  ...
  return (
    <div className="authentication-bg position-relative" style={{height:'100vh', display:'flex',justifyContent:'center',alignItems:'center'}}>
              ...
              <div className="card">
                <div className="card-body p-4">
                  <div className="text-center">
                    ...
                    <div style={{display:'flex',justifyContent:'space-between',marginTop:'0em'}}>
                      <div className="col-md-4">
                        <div className="text-center mt-3 ps-1 pe-1">
                        <Center mb={'1em'}>
                        <Center  style={{borderRadius:"50%",background:"#815ac5",color:'#fff',width:'50px',height:'50px'}}>
                          <i className="ri-vip-diamond-line "></i>
                          </Center>
                        </Center>
                          <Text fz={'17px'} className="text-uppercase">Why is the Site Down?</Text>
                      ...
                      <div className="col-md-4">
                        ...
                        <Center  style={{borderRadius:"50%",background:"#815ac5",color:'#fff',width:'50px',height:'50px'}}>
                          ...
                          <Text fz={'17px'} className="text-uppercase">What is the Downtime?</Text>
                          <Text className="text-muted" fz={'12px'}>
                      ...
                      <div className="col-md-4">
                        ...
                        <Center  style={{borderRadius:"50%",background:"#815ac5",color:'#fff',width:'50px',height:'50px'}}>
                          ...
                          <Text fz={'17px'}  className="text-uppercase">Do you need Support?</Text>
                          <Text className="text-muted" fz={'12px'}>
